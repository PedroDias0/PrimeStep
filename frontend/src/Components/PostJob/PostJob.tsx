    ...
    return <div data-aos="zoom-out" className="px-16 bs-mx:px-10 md-mx:px-5 py-5 ">
        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-10 md-mx:gap-5 [&>*]:w-1/2 sm-mx:[&>*]:!w-full sm-mx:flex-wrap">
                ...
                <NumberInput data-aos="zoom-out"  {...form.getInputProps("packageOffered")} withAsterisk label="Salary (€)" placeholder="Enter Salary" hideControls min={1} max={300} clampBehavior="strict" />
            </div>
